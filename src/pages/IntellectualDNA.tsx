        ...
        <div className="flex-1 flex flex-col items-center justify-center w-full space-y-6 py-12">
          <div className="space-y-6 text-center">
            ...
            <button
              ...
              className="w-full max-w-xs mx-auto bg-[#373763] text-[#E9E7E2] rounded-2xl py-4 px-8 font-oxanium uppercase tracking-wider text-sm font-bold hover:opacity-90 transition-opacity duration-200"
            >
              GET STARTED
            </button>
