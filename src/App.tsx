              ...
              <TooltipProvider>
                <ErrorBoundary>
                  ...
                  <Routes>
                    ...
                    <Route path="/bookshelf/:id" element={<BookshelfBookView />} />
                    <Route path="/virgil" element={<VirgilModes />} />
                    <Route path="/virgil-chat" element={<VirgilChat />} />
                    <Route path="/upgrade" element={<UpgradePage />} />
                    <Route path="/profile/subscription-success" element={<SubscriptionSuccessPage />} />
                  </Routes>
                </ErrorBoundary>
              </TooltipProvider>
            </ThemeProvider>
