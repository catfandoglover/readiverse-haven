...
// Mock data for politics domain resources
const mockPoliticsResources = [
  {
    id: "1",
    title: "The Republic",
    author: "Plato",
...
const PoliticsContent: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-medium">POLITICS</h3>
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {mockPoliticsResources.map((resource) => (
