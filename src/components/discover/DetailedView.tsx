...
const DetailedView: React.FC<DetailedViewProps> = ({
  ...
  const renderHeader = () => (
    <header className="backdrop-blur-sm bg-gradient-to-b from-white/30 to-white/10 border-b border-[#E9E7E2]/10 sticky top-0 z-10">
      <div className="flex items-center justify-between px-4 py-4">
        <button
          onClick={handleBack}
          className="h-10 w-10 inline-flex items-center justify-center rounded-md text-[#2A282A] hover:bg-[#2A282A]/10 transition-colors"
