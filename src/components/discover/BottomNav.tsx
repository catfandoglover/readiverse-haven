...
const BottomNav: React.FC<BottomNavProps> = ({ activeTab }) => {
  ...
  return (
    <div className="bg-[#D9D9D9]" style={{ height: "65px" }}>
      <div className="flex justify-between items-center max-w-sm mx-auto px-8 h-full">
        <button
          className={`inline-flex flex-col items-center justify-center gap-1 rounded-md text-[#282828] hover:bg-accent hover:text-accent-foreground transition-all duration-200 ${
            activeTab === "discover"
