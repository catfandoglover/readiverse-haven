          ...
          {activeSection === "become" ? (
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-[#383741] shadow-inner">
                <h2 className="text-xl font-oxanium allcaps mb-3">Key Tensions</h2>
              ...
              <div className="p-4 rounded-xl bg-[#383741] shadow-inner">
                <h2 className="text-xl font-oxanium allcaps mb-3">Natural Strengths</h2>
                <ul className="list-disc pl-5 space-y-2 font-baskerville text-[#E9E7E2]/80">
              ...
              <div className="p-4 rounded-xl bg-[#383741] shadow-inner">
                <h2 className="text-xl font-oxanium allcaps mb-3">Growth Edges</h2>
                <ul className="list-disc pl-5 space-y-2 font-baskerville text-[#E9E7E2]/80">
