-- First, add Virgil to favorites for all existing users who don't already have him
INSERT INTO public.user_favorites (user_id, item_id, item_type, added_at)
SELECT 
  user_id, 
...
WHERE 
  ...
  AND NOT EXISTS (
    ...
    WHERE user_favorites.user_id = profiles.user_id 
