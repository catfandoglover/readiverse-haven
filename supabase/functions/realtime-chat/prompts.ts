...
export const getDNAPrompt = () => {
  ...
  const questionsMap = {
    ...
    'EPISTEMOLOGY': {
      ...
      'AA': "How do we primarily gain reliable knowledge? A) Through logical reasoning and rational analysis. B) Through empirical observation and direct experience.",
