...
graph TD
    ...
    BAA -->|No| BAAB["Can ritual create real change?"]
...
graph TD
    ...
    BBA -->|Disagree| BBAB["'Pure logical thinking can reveal truths about reality.' Agree/Disagree?"]
...
graph TD
    ...
    BBA -->|No| BBAB["Should we value stability over perfect justice?"]
